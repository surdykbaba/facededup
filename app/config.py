...
class Settings(BaseSettings):
    ...
    LIVENESS_OPTIONAL_TOLERANCE: int = 0  # how many optional checks can fail (0 = all must pass)
    LIVENESS_DET_SCORE_MIN: float = 0.90
    LIVENESS_SHARPNESS_MIN: float = 100.0
    LIVENESS_SHARPNESS_MAX: float = 2000.0
    LIVENESS_LBP_VARIANCE_MIN: float = 500.0
    LIVENESS_COLOR_STD_MIN: float = 25.0
    LIVENESS_FACE_SIZE_RATIO_MIN: float = 0.05
    LIVENESS_FACE_SIZE_RATIO_MAX: float = 0.80
    LIVENESS_GLARE_RATIO_MAX: float = 0.05
    LIVENESS_LANDMARK_QUALITY_MIN: float = 0.75
    LIVENESS_EMBEDDING_NORM_MIN: float = 18.0
    LIVENESS_EMBEDDING_NORM_MAX: float = 30.0
    LIVENESS_SKIN_PIXEL_RATIO_MIN: float = 0.20
    LIVENESS_SKIN_SAT_MIN: int = 15
    LIVENESS_SKIN_SAT_MAX: int = 200
    LIVENESS_SKIN_SAT_STD_MIN: float = 12.0
    LIVENESS_DCT_HIGH_FREQ_MIN: float = 0.03
    LIVENESS_EDGE_DENSITY_MIN: float = 0.04
    LIVENESS_EDGE_DENSITY_MAX: float = 0.30
